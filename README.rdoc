...
The endpoint is defined dynamically and can be arbitrary execept for 'websocket'
...
* WebsocketRails (secret ingredient that makes live update without page refresh possible)
* Coffeescript
* Rspec with Shoulda
* Factory Girl
* jQuery
